...
def parse_args():
    ...
    parser.add_argument(
        "--subtitle-srt", type=str, default=None,
        help="Optional SRT file. Its timestamps limit the processing timeline."
    )
    parser.add_argument(
        "--srt-padding-before", type=int, default=None,
        help="Optional frame padding before each SRT cue. Overrides the configured timeline backward frames."
    )
    parser.add_argument(
        "--srt-padding-after", type=int, default=None,
        help="Optional frame padding after each SRT cue. Overrides the configured timeline forward frames."
    )
    parser.add_argument(
